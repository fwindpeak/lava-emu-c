/**
  ...
  *             "SD_DMA_MODE" or "SD_POLLING_MODE" inside the sdcard_sdio.h
...
/** @brief sdcard_sdio_Private_Variables
  */
...
/** @brief sdcard_sdio_Private_Function_Prototypes
  * @{
  */
...
/** @defgroup sdcard_sdio_Private_Functions
  * @{
  */  
