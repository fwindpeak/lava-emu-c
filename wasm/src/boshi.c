...
//----------------------------------------------------------------
unsigned char MapData[][MAP_MAX_WIDTH_OBJ]= {
...
const unsigned char GraphicData[]= {
...
//----------------------------------------------------------------
int g_iThingCount;
unsigned char g_caThingBox[10];
unsigned char g_saThingBox[10][11];

unsigned char g_saMainManualItems[3][11]= {
    "交谈　　  ", "查看四周  ", "使用物品  "
};
...
//----------------------------------------------------------------
void Thing_GetObjectName(unsigned char cThingID, uchar * sName)
{
...
//----------------------------------------------------------------
void Thing_Exchange(unsigned char cOldThingID, unsigned char cNewThingID)
{
    int i;
...
//----------------------------------------------------------------
int Thing_Add(unsigned char cThingID)
{
    int i;
